...
function EmailScannerPage({ backendStatus }) {
    ...
    <ThemeProvider theme={elegantTheme}>
      ...
      <PageContainer>
        ...
        >
          ...
          <Subtitle>
            AI-powered spam and phishing detection • Real-time analysis •
        ...
        <ContentContainer>
          ...
          >
            <EmailScanner backendStatus={backendStatus} />
          </motion.div>
        </ContentContainer>
      </PageContainer>
    </ThemeProvider>
...
//         </Title>
//         <Subtitle>
//           AI-powered spam and phishing detection • Real-time analysis • Advanced pattern recognition
//         </Subtitle>
//       </Header>
